...
with Client() as c:
    ...
    html = c.fetch_html(
        "https://www.csfd.cz/zebricky/filmy/nejlepsi/", wait_for_selector="article.article-poster-60", use_cache=not TEST_FETCH)
    print(f"len={len(html)} has_films={'article-poster-60' in html} anubis_blocked={'Access Denied' in html}")
